...
\IfFileExists{pareval_numbers.tex}{\input{pareval_numbers}}{\input{pareval_defaults}}
\IfFileExists{injected_numbers.tex}{\input{injected_numbers}}{%
  \newcommand{\Ninjected}{\textsc{tbd}}\newcommand{\NinjectedCaught}{\textsc{tbd}}}
\IfFileExists{cross_numbers.tex}{\input{cross_numbers}}{%
...
\IfFileExists{scaling_numbers.tex}{\input{scaling_numbers}}{%
...
\title{Correct but Not Parallel: Two-Axis Verifiable Rewards\\
for Agent-Generated HPC Code}
...
engineering, verifiable rewards, reward design, reinforcement learning, GRPO,
differential testing, correctness, parallel efficiency, data races
\end{IEEEkeywords}

\input{sections/1_introduction}
\input{sections/3_metric}
\input{sections/4_setup}
\input{sections/5_results}
\input{sections/5b_experiments}
