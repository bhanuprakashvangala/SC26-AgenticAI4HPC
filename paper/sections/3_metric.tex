...
production run will use. Because an agent accepts its code on this same
measurement---and a verifiable-reward RL loop would optimize it---these are not
merely metrics but the \emph{specification} the model is steered toward;
Section~\ref{sec:reward} builds directly on them to design the reward.
